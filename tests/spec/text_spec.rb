...
describe 'Text' do
  it 'Renders Text components' do
    ...
    expect(page).to have_selector 'h2', text: 'Text - First - section heading'
    expect(page).to have_selector '.govuk-summary-list__key', text: 'Text - First'
    expect(page).to have_selector '.govuk-summary-list__value', text: 'One'

    expect(page).to have_selector 'h2', text: 'Text - Second - section heading'
    expect(page).to have_selector '.govuk-summary-list__key', text: 'Text - Second'
    expect(page).to have_selector '.govuk-summary-list__value', text: 'Two' # - summary version'

    expect(page).to have_selector 'h2', text: 'Text - Third - section heading'
    expect(page).to have_selector '.govuk-summary-list__key', text: 'Text - Third'
